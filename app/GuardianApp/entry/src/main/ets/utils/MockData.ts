...
import { Elderly, AlertRecord, HistoryRecord, ActivityStatus, AlertType } from '../model/Types';
...
export class MockData {
  ...
  static alerts: AlertRecord[] = [
    ...
    },
    {
      ...
      description: '心率持续超过110bpm',
      isRead: true
    }
  ];

  static history: HistoryRecord[] = [
    { id: 'h1', status: ActivityStatus.WALKING, startTime: '14:00', duration: '30分钟' },
    { id: 'h2', status: ActivityStatus.SITTING, startTime: '12:30', duration: '1小时30分' },
    { id: 'h3', status: ActivityStatus.STILL, startTime: '12:00', duration: '30分钟' },
    { id: 'h4', status: ActivityStatus.WALKING, startTime: '10:00', duration: '2小时' }
  ];
}
